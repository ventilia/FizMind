...
public class InputController {
    ...
    private void saveUnknown() {
        if (unknownDisplayDesignation != null) {
            ...
            String displayText = unknownDisplayDesignation + (subscript.isEmpty() ? "" : "_" + subscript) + " = ?";
    ...
    public void onDownArrowPressed() {
        if ("designations".equals(currentInputField)) {
            ...
            if (operationBuffer.length() > 0) {
                displayText += operationBuffer + "(" + displayDesignation + ")";
            } else {
                displayText += displayDesignation;
            }
            if (!subscript.isEmpty()) {
                displayText += "_" + subscript;
            }
            displayText += " = " + SIConverter.formatValue(value) + " " + unit;
            ...
            ConcreteMeasurementEntity measurement = new ConcreteMeasurementEntity(
                    ...
                    subscript, isCurrentConstant, displayText,
