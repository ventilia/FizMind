...
/**
 * анализатор ввода для поиска цепочки формул с использованием графа зависимостей
 */
public class InputAnalyzer {
    ...
    public List<Formula> findFormulaPath(Map<String, Double> knownValues, String unknown) {
        ...
        while (!queue.isEmpty()) {
            ...
            // если нашли неизвестную величину
            ...
            // получаем все формулы, связанные с текущей величиной
