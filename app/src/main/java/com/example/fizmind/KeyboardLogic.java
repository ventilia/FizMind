    ...
    public class KeyboardLogic {
        ...
        private String currentMode = "Designation"; //умолчание
       ...
       //еги режимов
            ...
            keyboardData.put("Units_of_measurement", Arrays.asList(
                    Arrays.asList(
                            ...
                            new SymbolKey("unit_mol", "mol", false),
                            new SymbolKey("unit_cd", "cd", false),
                            // переход
                            new SymbolKey("unit_m_dup", "m", false),
                            new SymbolKey("unit_kg_dup", "kg", false),
                            new SymbolKey("unit_s_dup", "s", false),
                            new SymbolKey("unit_A_dup", "A", false),
                            new SymbolKey("unit_K_dup", "K", false),
                            new SymbolKey("unit_mol_dup", "mol", false),
                            new SymbolKey("unit_cd_dup", "cd", false),
                            // переход
                            ...
                            new SymbolKey("unit_C", "C", false),
                            new SymbolKey("unit_V", "V", false)
                    ),
                    // Страница 2
                    Arrays.asList(
                            new SymbolKey("unit_F", "F", false),
                            new SymbolKey("unit_Ohm", "Ω", false),
                            new SymbolKey("unit_S", "S", false),
                            new SymbolKey("unit_H", "H", false),
                            new SymbolKey("unit_T", "T", false),
                            new SymbolKey("unit_lm", "lm", false),
                            new SymbolKey("unit_lx", "lx", false),
                            // переход
                            new SymbolKey("unit_m3", "m", false),
                            new SymbolKey("unit_kg3", "kg", false),
                            new SymbolKey("unit_s3", "s", false),
                            new SymbolKey("unit_A3", "A", false),
                            new SymbolKey("unit_K3", "K", false),
                            new SymbolKey("unit_mol3", "mol", false),
                            new SymbolKey("unit_cd3", "cd", false),
                            // переход
                            new SymbolKey("unit_Bq", "Bq", false),
                            new SymbolKey("unit_Gy", "Gy", false),
                            new SymbolKey("unit_Sv", "Sv", false),
                            new SymbolKey("unit_kat", "kat", false),
                            new SymbolKey("unit_eV", "eV", false),
                            new SymbolKey("unit_MeV", "MeV", false),
                            new SymbolKey("unit_keV", "keV", false)
                    )
            ));
            ...
            keyboardData.put("Numbers_and_operations", Arrays.asList(
                    Arrays.asList(
                            ...
                            new SymbolKey("num_dot2", ".", false),
                            new SymbolKey("num_dot3", ".", false),
                            new SymbolKey("num_dot4", ".", false),
                            // переход
                            new SymbolKey("num_4", "4", false),
                            new SymbolKey("num_5", "5", false),
                            new SymbolKey("num_6", "6", false),
                            new SymbolKey("num_dot5", ".", false),
                            new SymbolKey("num_dot6", ".", false),
                            new SymbolKey("num_dot7", ".", false),
                            new SymbolKey("num_dot8", ".", false),
                            // переход
                            new SymbolKey("num_7", "7", false),
                            new SymbolKey("num_8", "8", false),
                            new SymbolKey("num_9", "9", false),
                            new SymbolKey("num_dot9", ".", false),
                            new SymbolKey("num_0", "0", false),
                            new SymbolKey("num_dot10", ".", false),
            ...
            //  обработчики смены режима переключения страниц
            setModeListeners();
            setPageListeners();
        ...
        public android.graphics.Typeface getStixTypeface() {
            return stixTypeface;
        }
                ...
                if (i < currentKeys.size()) {
                    ...
                    keyView.setOnClickListener(view -> {
                        ...
                        if (inputController != null) {
                            if (currentMode.equals("Designation") && useStixFont) {

                                inputController.onKeyInput(logicalId, currentMode, useStixFont);
                            } else {
                                inputController.onKeyInput(displayText, currentMode, useStixFont);
                            }
                        }
                    });
